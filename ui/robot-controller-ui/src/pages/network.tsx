 ...
 *
 * Tabs:
 *  Live Control  — real-time status, mode switch, Wi-Fi scan/connect, hotspot, Tailscale
 *  AP / Hotspot  — connected client list
 *  Startup Config — persistent startup config saved to robot
 *  Profiles      — UI-side connection profile manager (which IP this browser uses)
 *  Diagnostics   — connection quality / latency testing
 */
      ...
      <div className="cyber-theme min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 space-y-5">
          ...
          {tab === 'profiles' && (
            <div className="space-y-4">
              <div className="text-xs text-white/50 px-1">
                Connection profiles control which IP/hostname <em>this browser</em> uses to reach the robot. Switching profiles does not change the robot&apos;s network — it changes how this browser connects.
              </div>
              <div className="bg-gray-800 border border-white/10 rounded-lg p-5">
                <div className="flex items-center gap-2 mb-4">
                  <Monitor className="w-4 h-4 text-purple-400" />
                  <h2 className="text-sm font-semibold text-white">Browser Connection Profiles</h2>
                </div>
